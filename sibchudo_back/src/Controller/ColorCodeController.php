...
class ColorCodeController extends AbstractController
{

    /**
     * @Route("/api/color_code/get", name="api_color_code_get")
    ...
    public function getBy(RepositoryLoader $loader, Request $request) {
        ...
        $cats = $loader->loadRepository(ColorCodeRepository::class)->getBy($criteria, $limit, $offset);
